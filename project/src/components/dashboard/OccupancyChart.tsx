        ...
        <div className="flex justify-center py-4">
          <div className="relative w-48 h-48">
            <svg viewBox="0 0 36 36" className="w-full h-full">
              {/* Circular background */}
              <circle cx="18" cy="18" r="15.9" fill="none" stroke="#f1f5f9" strokeWidth="3.8"></circle>
              ...
              {/* Center text */}
              <text x="18" y="17" textAnchor="middle" className="text-3xl font-bold fill-gray-700">
                {data.occupancyRate}%
              </text>
              <text x="18" y="22" textAnchor="middle" className="text-xs fill-gray-500">
                Occupancy
              </text>
            </svg>
          </div>
